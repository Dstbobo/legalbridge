...
//
// Admin-only: caller must present a verified user JWT with a server-managed
// LegalBridge admin role. Run with
...
//
// The service-role credential is used only inside this function.
