...
function updateHtml(name: string): string {
  return `<!DOCTYPE html>
<html lang="en">
    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(13,27,62,0.08);">
        ...
        <tr><td style="padding:32px;">
          <p style="font-size:18px;font-weight:700;color:#0d1b3e;margin:0 0 14px;">LegalBridge now speaks your language, ${name} 🇳🇬</p>
          <p style="font-size:15px;line-height:23px;color:#3a4256;margin:0 0 18px;">
            Big update! LegalBridge just got its biggest upgrade yet:
          </p>
          <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 22px;">
            <tr><td style="padding:6px 0;font-size:15px;color:#3a4256;">🗣️&nbsp;&nbsp;<strong>Ask in your language</strong> — get answers in Hausa, Nigerian Pidgin, Yorùbá, or Igbo. Pick your language in Profile.</td></tr>
            <tr><td style="padding:6px 0;font-size:15px;color:#3a4256;">✨&nbsp;&nbsp;<strong>A beautiful new look</strong> — new logo, smoother screens, faster opening</td></tr>
            <tr><td style="padding:6px 0;font-size:15px;color:#3a4256;">📰&nbsp;&nbsp;<strong>Discover</strong> — legal news, grants and opportunities, made for you</td></tr>
          </table>
          <p style="font-size:15px;line-height:23px;color:#3a4256;margin:0 0 18px;">
            <strong>Update LegalBridge on Google Play</strong> and try asking a question in your own
            language — it feels like magic.
          </p>
    ...
    try {
      const res = await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: FROM,
          to: [t.email],
          subject: 'LegalBridge now speaks your language 🇳🇬',
          html: updateHtml(t.name),
